...
class ColorWheel():
    ...
    @staticmethod
    def hex_to_rgb(self, hex_code, normalize: str = False):
        """
    ...
    def lighten_color(self, color, amount: str = 1, return_rgb: str = False):
        """
    ...
    def blend_colors(self, color1, color2, ratio: str = .5):
        """
        ...
        """
        colorRGBA1: str = self.hex_to_rgb(color1)
        colorRGBA2: str = self.hex_to_rgb(color2)
